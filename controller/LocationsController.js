...
export const updateLocationById = async (req, res) => {
  try {
    ...
    const dataToUpdate = {
      ...
      latitude: updateData.latitude ? parseFloat(updateData.latitude) : existingLocation.latitude,
      longitude: updateData.longitude ? parseFloat(updateData.longitude) : existingLocation.longitude,
      options: updateData.options || existingLocation.options,
